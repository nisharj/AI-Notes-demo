    ...
    <div className="min-h-screen" style={{ backgroundColor: '#FDFCF8' }}>
      ...
      <main className="max-w-4xl mx-auto p-6 mt-8">
        <div className="bg-white rounded-lg shadow-lg border border-stone-200 p-8">
          <h1 className="text-3xl font-heading font-bold tracking-tight mb-8">Profile Settings</h1>

          <div className="space-y-8">
            {/* Avatar Section */}
            <div className="flex items-center space-x-6" data-testid="avatar-section">
            ...
            <div className="space-y-4 pt-6 border-t">
              ...
              <div className="p-4 bg-primary/5 rounded-md border border-primary/10">
                <p className="text-sm text-muted-foreground">
                  <strong>Note:</strong> Profile information is currently read-only. Contact support to update your details.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4 pt-6 border-t">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-white rounded-lg border" data-testid="feature-summary">
                ...
                <div className="p-4 bg-white rounded-lg border" data-testid="feature-search">
                  <div className="flex items-center space-x-2 mb-2">
                    <Sparkles className="h-5 w-5 text-primary" />
                ...
                <div className="p-4 bg-white rounded-lg border" data-testid="feature-assistant">
                  <div className="flex items-center space-x-2 mb-2">
                    <Sparkles className="h-5 w-5 text-primary" />
                ...
                <div className="p-4 bg-white rounded-lg border" data-testid="feature-reminders">
                  <div className="flex items-center space-x-2 mb-2">
                    <Sparkles className="h-5 w-5 text-primary" />
