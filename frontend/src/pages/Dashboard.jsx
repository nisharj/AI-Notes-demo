...
import { 
  Plus, Search, Sparkles, FileText, Trash2, Edit, Calendar,
  FolderOpen, Tag as TagIcon, LogOut, User, Brain
} from 'lucide-react';
    ...
    <div className="flex h-screen" style={{ backgroundColor: '#FDFCF8' }}>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-2">
          ...
          {folders.map((f) => (
            <button
              ...
              className={`w-full flex items-center space-x-2 px-3 py-2 rounded-md transition-colors ${
                selectedFolder === f.name ? 'bg-primary text-white' : 'hover:bg-muted'
              }`}
            ...
            <div className="flex items-center space-x-3">
              ...
              <Dialog open={isCreateModalOpen} onOpenChange={setIsCreateModalOpen}>
                <DialogTrigger asChild>
                  <Button onClick={() => { resetForm(); setIsCreateModalOpen(true); }} data-testid="create-note-button">
                ...
                <DialogContent className="max-w-2xl">
                  ...
                  <form onSubmit={handleCreateNote} className="space-y-4" data-testid="create-note-form">
                    <Input
                    ...
                    />
                    <Button type="submit" disabled={loading} data-testid="create-note-submit">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {notes.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full" data-testid="empty-state">
              ...
              />
              <h3 className="text-xl font-heading font-semibold mb-2">No notes yet</h3>
              <p className="text-muted-foreground mb-6">Create your first note to get started</p>
              <Button onClick={() => setIsCreateModalOpen(true)} data-testid="empty-create-button">
                <Plus className="h-4 w-4 mr-2" />
                Create Note
              </Button>
            </div>
              ...
              {notes.map((note) => (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <h3 className="font-heading font-semibold text-lg flex-1 pr-2">{note.title}</h3>
                    <div className="flex items-center space-x-1">
                      <button
                        onClick={(e) => { e.stopPropagation(); openEditMode(note); }}
                  ...
                  <div className="flex items-center justify-between text-xs text-muted-foreground">
                    ...
                    {note.scheduled_reminder && (
                      <span className="flex items-center" data-testid="reminder-badge">
      ...
      <Dialog open={isEditMode} onOpenChange={setIsEditMode}>
        <DialogContent className="max-w-2xl">
          ...
          <form onSubmit={handleUpdateNote} className="space-y-4" data-testid="edit-note-form">
            <Input
              placeholder="Note title"
              value={title}
              onChange={(e) => setTitle(e.target.value)}
            ...
            />
            <Button type="submit" disabled={loading} data-testid="edit-note-submit">
